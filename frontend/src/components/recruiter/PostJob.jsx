...
const PostJob = () => {
    ...
    return (
        <div className="min-h-screen bg-[#020817] text-white pt-24 px-4 md:px-8 pb-12 font-sans relative flex items-start justify-center">
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                        ...
                        <div className="space-y-2 md:col-span-2 mt-2">
                             ...
                             {companies.length > 0 ? (
                                ...
                                <p className='text-sm text-red-500 bg-red-500/10 p-4 border border-red-500/20 rounded-xl'>*Please record a company entry first before posting jobs.</p>
                            )}
                        </div>
                    </div> 
                    {
