...
const ParticipantTile = ({
  ...
  <div
    className={`relative w-full h-full rounded-2xl flex items-center justify-center overflow-hidden border border-slate-800 backdrop-blur-md transition-all duration-300 ${isSpeaking ? "bg-[#1e293b]/80 shadow-[0_0_15px_-5px_rgba(59,130,246,0.2)]" : "bg-[#111b27]/60"}`}
  >
    {isSpeaking && (
...
const InterviewRoom = () => {
  ...
  if (!initialReportId || totalQuestions === 0) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-[#09090b] text-white min-w-[1280px]">
        <div className="text-center p-8 bg-[#111b27] rounded-xl shadow-2xl border border-red-500/30">
    ...
    <div className="flex h-screen w-screen bg-[#09090b] text-white font-sans min-w-[1280px] bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-blue-900/10 via-gray-950 to-gray-950">
      ...
      <div className="w-[70%] h-full bg-[#111b27]/80 backdrop-blur-xl border-l border-slate-800 p-8 flex flex-col justify-between shadow-2xl relative">
        ...
        <div className="flex-1 py-8 overflow-y-auto space-y-8 no-scrollbar">
          <div className="p-6 bg-gradient-to-br from-[#111b27] to-[#09090b] rounded-2xl border border-slate-800 shadow-lg relative overflow-hidden">
          ...
          {isTextBoxQuestion && interviewStatus === "running" && (
            <div className="p-6 bg-[#09090b]/80 rounded-2xl border border-blue-500/30 shadow-[0_0_30px_-10px_rgba(59,130,246,0.2)] transition-all">
              ...
              <textarea
                className="w-full h-64 p-4 bg-[#09090b] text-green-400 border border-slate-800 rounded-xl font-mono text-sm leading-relaxed focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 resize-none transition-all placeholder-gray-600"
        ...
        <div className="flex flex-col items-center pt-8 border-t border-slate-800">
                  ...
                  <ControlButton
                    ...
                    className={`flex-1 flex justify-center items-center h-16 rounded-xl border transition-all ${
                      isMicOn
                        ...
                        : "bg-[#111b27] border-slate-800 hover:bg-slate-800 text-gray-300"
                    }`}
                    disabled={
                      isInterviewerSpeaking ||
          ...
          {interviewStatus === "finished" && (
            <div className="w-full space-y-4">
              ...
              <ControlButton
                onClick={() => navigate(`/candidate/report/${reportId}`)}
